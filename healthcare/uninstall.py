...
def before_uninstall():
	try:
		print("Removing customizations created by Biograph...")
		remove_customizations()

	except Exception as e:
		BUG_REPORT_URL = "https://github.com/frappe/health/issues/new"
		click.secho(
			"Removing Customizations for Biograph failed due to an error."
			" Please try again or"
	...
	click.secho("Biograph app customizations have been removed successfully...", fg="green")
