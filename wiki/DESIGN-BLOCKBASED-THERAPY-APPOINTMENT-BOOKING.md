...
6. **Cancel Appointment**
   - Click "Cancel" to cancel the appointment - we need to use the same existing cancel button of Patient Appointment Button. 
   - System shows a dialog with the option to cancel the appointment
